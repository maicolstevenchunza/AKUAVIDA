...
public class InventarioTestJPA {
    ...
    public void buscarPorCantidad() {
        ...
        for (Inventario inventatioT : lis) {
            ...
            System.out.println("Id inventario" + inventatioT.getInventarioPK() + " Producto comprado " + inventatioT.getCantidadProductoComprado() + " Fecha de compra " + inventatioT.getFechaDeCompra());
        }
    ...
    public void buscarPorFecha() {
        ...
        query.setParameter("fechaDeCompra", fechaTemporal);
